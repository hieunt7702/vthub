        ...
        <nav className="hidden md:flex items-center gap-5 lg:gap-6 text-sm justify-center shrink-0">
          <Link 
            ...
            className={`relative inline-flex items-center gap-1.5 transition whitespace-nowrap font-semibold ${
              isActive("/", true) ? "text-teal-400" : "text-zinc-400 hover:text-teal-300"
            }`}
          >
            <span>Trang chủ</span>
          </Link>
          ...
          <Link 
            ...
            className={`relative inline-flex items-center gap-1.5 transition whitespace-nowrap font-semibold ${
              isActive("/ib-commission-overview") ? "text-teal-400" : "text-zinc-400 hover:text-teal-300"
            }`}
          >
          ...
          <Link 
            href="/offers-bonus" 
            className={`relative inline-flex items-center gap-1.5 transition whitespace-nowrap font-semibold ${
              isActive("/offers-bonus") ? "text-teal-400" : "text-zinc-400 hover:text-teal-300"
            }`}
          >
          ...
          <details className="hidden md:block relative group" data-hh-nav-dropdown="">
            <summary className="list-none cursor-pointer inline-flex items-center gap-1.5 text-sm transition font-semibold text-zinc-400 hover:text-teal-300">
              <span>Tools</span>
          ...
          <Link 
            href="/contact" 
            className={`relative inline-flex items-center gap-1.5 transition whitespace-nowrap font-semibold ${
              isActive("/contact") ? "text-teal-400" : "text-zinc-400 hover:text-teal-300"
            }`}
          >
            <span>Support</span>
          </Link>
        ...
        <div className="flex flex-1 items-center justify-end gap-3 shrink-0">
          ...
          <div className="hidden md:inline-flex items-center text-xs text-zinc-400 border border-white/10 rounded overflow-hidden">
            <button
              ...
              className={`px-2.5 py-1 transition ${
                language === "vi" ? "bg-teal-500/20 text-teal-300 font-bold" : "hover:bg-white/5"
              }`}
            >
              VI
            </button>
            <button
              ...
              className={`px-2.5 py-1 transition ${
                language === "en" ? "bg-teal-500/20 text-teal-300 font-bold" : "hover:bg-white/5"
              }`}
            >
              EN
            </button>
          ...
          {isVtLinked ? (
            <details className="hidden sm:block relative group" data-hh-nav-dropdown="">
              <summary className="list-none cursor-pointer inline-flex items-center outline-none">
                <div className="h-9 w-9 rounded-full bg-gradient-to-br from-teal-400 to-teal-600 p-[2px] shadow-lg shadow-teal-500/20 hover:scale-105 transition-transform">
                ...
                <div className="rounded border border-white/10 bg-zinc-900/95 backdrop-blur-xl shadow-2xl overflow-hidden p-2">
                  <div className="p-3 border-b border-white/10 mb-2">
                    ...
                    <div className="text-sm text-white font-bold tracking-wide flex items-center justify-between">
                      VTM-982412
                      <span className="px-2 py-0.5 rounded bg-teal-500/10 border border-teal-500/20 text-teal-400 text-[9px] font-bold uppercase tracking-wider">Đã kết nối</span>
                    </div>
                  </div>
                  <Link href="/rewards" className="flex items-center gap-2 rounded px-3 py-2 text-sm transition text-zinc-300 hover:bg-white/5 hover:text-teal-300 group">
                    <svg className="w-4 h-4 text-zinc-400 group-hover:text-teal-400 transition" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button onClick={handleLinkAccount} className="hidden sm:inline-flex rounded bg-gradient-to-r from-teal-400 to-teal-600 px-4 py-2 text-sm font-semibold text-zinc-950 hover:from-teal-300 hover:to-teal-500 transition shadow-lg shadow-teal-500/30 whitespace-nowrap">
              Liên kết tài khoản
            </button>
          )}
          ...
          <details className="md:hidden relative">
            ...
            <div className="absolute right-0 top-full mt-2 w-72 max-h-[80vh] overflow-y-auto rounded border border-white/10 bg-zinc-900/95 backdrop-blur-md shadow-2xl p-2 z-50">
              <Link href="/" className={`flex items-center gap-2 rounded px-3 py-2 text-sm transition font-semibold ${isActive("/", true) ? "text-teal-400 bg-teal-500/10" : "text-zinc-300 hover:bg-white/5"}`}>
                <span className="flex-1">Trang chủ</span>
              </Link>
              <Link href="/rewards" className={`flex items-center gap-2 rounded px-3 py-2 text-sm transition font-semibold ${isActive("/rewards") ? "text-teal-400 bg-teal-500/10" : "text-zinc-300 hover:bg-white/5"}`}>
                <svg className="w-4 h-4 text-teal-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7" />
                </svg>
                <span className="flex-1">Rewards</span>
              </Link>
              <Link href="/ib-commission-overview" className={`flex items-center gap-2 rounded px-3 py-2 text-sm transition font-semibold ${isActive("/ib-commission-overview") ? "text-teal-400 bg-teal-500/10" : "text-zinc-300 hover:bg-white/5"}`}>
                <span className="flex-1">IB Partner</span>
              </Link>
              <Link href="/offers-bonus" className={`flex items-center gap-2 rounded px-3 py-2 text-sm transition font-semibold ${isActive("/offers-bonus") ? "text-teal-400 bg-teal-500/10" : "text-zinc-300 hover:bg-white/5"}`}>
              ...
              <Link href="/indicators" className={`flex items-center gap-2 rounded px-3 py-2 text-sm transition font-semibold ${isActive("/indicators") ? "text-teal-400 bg-teal-500/10" : "text-zinc-300 hover:bg-white/5"}`}>
                <span className="flex-1">Chỉ báo & EA</span>
              </Link>
              <Link href="/gia-vang-hom-nay" className={`flex items-center gap-2 rounded px-3 py-2 text-sm transition font-semibold ${isActive("/gia-vang-hom-nay") ? "text-teal-400 bg-teal-500/10" : "text-zinc-300 hover:bg-white/5"}`}>
                <span className="flex-1">Giá vàng Live</span>
              </Link>
              <Link href="/passview" className={`flex items-center gap-2 rounded px-3 py-2 text-sm transition font-semibold ${isActive("/passview") ? "text-teal-400 bg-teal-500/10" : "text-zinc-300 hover:bg-white/5"}`}>
                <span className="flex-1">Passview</span>
              </Link>
              <Link href="/courses" className={`flex items-center gap-2 rounded px-3 py-2 text-sm transition font-semibold ${isActive("/courses") ? "text-teal-400 bg-teal-500/10" : "text-zinc-300 hover:bg-white/5"}`}>
                <span className="flex-1">Khóa học</span>
              </Link>
              <Link href="/predictions" className={`flex items-center gap-2 rounded px-3 py-2 text-sm transition font-semibold ${isActive("/predictions") ? "text-teal-400 bg-teal-500/10" : "text-zinc-300 hover:bg-white/5"}`}>
                <span className="flex-1">Dự đoán</span>
              </Link>

              <div className="my-2 border-t border-white/5"></div>

              <Link href="/contact" className={`flex items-center gap-2 rounded px-3 py-2 text-sm transition font-semibold ${isActive("/contact") ? "text-teal-400 bg-teal-500/10" : "text-zinc-300 hover:bg-white/5"}`}>
              ...
              <div className="mt-2 pt-2 border-t border-white/10 flex items-center gap-2 px-3 text-xs">
                ...
                <button
                  type="button"
                  onClick={() => setLanguage("vi")}
                  className={`px-2 py-0.5 rounded ${language === "vi" ? "bg-teal-500/20 text-teal-300 font-bold" : "text-zinc-400"}`}
                >
                  VI
                </button>
                <button
                  type="button"
                  onClick={() => setLanguage("en")}
                  className={`px-2 py-0.5 rounded ${language === "en" ? "bg-teal-500/20 text-teal-300 font-bold" : "text-zinc-400"}`}
                >
                  EN
                </button>
              </div>
              ...
              <div className="mt-2 pt-2 border-t border-white/10">
                {isVtLinked ? (
                  ...
                  <button onClick={handleLinkAccount} className="w-full block rounded bg-gradient-to-r from-teal-400 to-teal-600 px-3 py-2 text-sm font-semibold text-zinc-950 text-center">
                    Liên kết tài khoản
                  </button>
                )}
              </div>
