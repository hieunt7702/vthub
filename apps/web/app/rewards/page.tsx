...
const REWARD_LEVELS = [
  ...
  { level: 1, title: "Tân Binh", lots: 10, reward: "$80", color: "from-teal-400 to-teal-500", icon: "🌱" },
  { level: 2, title: "Gắn Kết", lots: 25, reward: "$200", color: "from-blue-400 to-indigo-500", icon: "🤝" },
  { level: 3, title: "Tiềm Năng", lots: 50, reward: "$450", color: "from-indigo-400 to-indigo-500", icon: "⭐" },
  { level: 4, title: "Chuyên Nghiệp", lots: 100, reward: "$1,000", color: "from-indigo-400 to-fuchsia-500", icon: "💼" },
  { level: 5, title: "Tinh Anh", lots: 250, reward: "$2,600", color: "from-fuchsia-400 to-pink-500", icon: "⚔️" },
  { level: 6, title: "Bậc Thầy", lots: 500, reward: "$5,500", color: "from-pink-400 to-indigo-500", icon: "🏆" },
  { level: 7, title: "Huyền Thoại", lots: 1000, reward: "$12,000", color: "from-indigo-400 to-red-500", icon: "👑" },
  { level: 8, title: "Đại Sứ", lots: 2500, reward: "$32,000", color: "from-blue-400 to-red-500", icon: "🦅" },
  { level: 9, title: "Kẻ Thống Trị", lots: 5000, reward: "$70,000", color: "from-cyan-400 to-blue-500", icon: "🦁" },
  { level: 10, title: "Thượng Đỉnh", lots: 10000, reward: "$150,000", color: "from-cyan-300 to-cyan-500", icon: "💎" },
];
    ...
    return (
      <>
        ...
        <main id="main-content" className="flex-grow bg-zinc-950 min-h-screen text-zinc-300 relative overflow-hidden flex flex-col">
          ...
          <div className="absolute top-0 inset-x-0 h-[600px] bg-gradient-to-b from-blue-500/10 via-blue-900/5 to-transparent pointer-events-none"></div>
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-gradient-to-tr from-cyan-500/10 to-blue-600/10 rounded blur-[120px] pointer-events-none"></div>
          ...
          <section className="relative pt-24 lg:pt-32 pb-16 lg:pb-24 z-10 border-b border-white/5">
            <ScrollReveal animation="fade-up" className="max-w-7xl mx-auto px-4 lg:px-8 text-center flex flex-col items-center">
              <div className="inline-flex items-center gap-2 rounded-full border border-blue-500/30 bg-blue-500/10 px-4 py-1.5 text-sm font-semibold text-blue-400 mb-8 shadow-[0_0_20px_rgba(249,115,22,0.15)]">
              ...
              <p className="mt-8 max-w-3xl mx-auto text-zinc-400 text-lg md:text-xl leading-relaxed font-medium">
                Liên kết tài khoản giao dịch của bạn để bắt đầu tích lũy khối lượng (lots), theo dõi tiến độ và mở khóa những phần thưởng độc quyền lên đến <span className="text-blue-400 font-semibold">$150,000</span>.
              </p>
            ...
            <div className="max-w-7xl mx-auto px-4 lg:px-8">
              <ScrollReveal animation="fade-up" className="text-center mb-16">
                <h2 className="text-3xl md:text-4xl font-bold text-white">
                  Cách <span className="bg-gradient-to-r from-blue-400 to-cyan-500 bg-clip-text text-transparent">tham gia</span> chương trình thưởng
                </h2>
              </ScrollReveal>
              
              <ScrollReveal animation="fade-up" staggerChildren={0.2} className="grid md:grid-cols-4 gap-8">
                <ScrollRevealItem className="relative p-6 rounded bg-white/[0.02] border border-white/5 hover:border-blue-500/30 hover:bg-white/[0.04] transition-all">
                  <div className="h-14 w-14 rounded-full bg-blue-500/20 border-2 border-blue-400 text-blue-400 text-xl font-bold flex items-center justify-center mb-6 shadow-[0_0_15px_rgba(251,146,60,0.3)]">1</div>
                  <div className="hidden md:block absolute top-12 left-24 right-0 h-[2px] bg-gradient-to-r from-blue-500/30 to-transparent"></div>
                ...
                <ScrollRevealItem className="relative p-6 rounded bg-white/[0.02] border border-white/5 hover:border-cyan-500/30 hover:bg-white/[0.04] transition-all">
                  <div className="h-14 w-14 rounded-full bg-cyan-500/20 border-2 border-cyan-400 text-cyan-400 text-xl font-bold flex items-center justify-center mb-6">2</div>
                  <div className="hidden md:block absolute top-12 left-24 right-0 h-[2px] bg-gradient-to-r from-cyan-500/30 to-transparent"></div>
                ...
                <ScrollRevealItem className="relative p-6 rounded bg-white/[0.02] border border-white/5 hover:border-cyan-500/30 hover:bg-white/[0.04] transition-all">
                  <div className="h-14 w-14 rounded-full bg-cyan-500/20 border-2 border-cyan-400 text-cyan-400 text-xl font-bold flex items-center justify-center mb-6">3</div>
                  <div className="hidden md:block absolute top-12 left-24 right-0 h-[2px] bg-gradient-to-r from-cyan-500/30 to-transparent"></div>
                ...
                <ScrollRevealItem className="relative p-6 rounded bg-white/[0.02] border border-white/5 hover:border-teal-500/30 hover:bg-white/[0.04] transition-all">
                  <div className="h-14 w-14 rounded-full bg-teal-500/20 border-2 border-teal-400 text-teal-400 text-xl font-bold flex items-center justify-center mb-6">4</div>
  ...
  return (
    <>
      ...
      <main id="main-content" className="flex-grow bg-[#090A0C] min-h-screen text-zinc-300 pb-20 relative">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-500/5 via-transparent to-transparent pointer-events-none"></div>
                      ...
                      <div key={level.level} className={`relative flex items-start gap-4 ${isLocked ? 'opacity-40' : ''}`}>
                        ...
                        <div className={`relative z-10 w-12 h-12 shrink-0 rounded flex items-center justify-center text-xl shadow-lg border ${
                          isCompleted 
                            ...
                            : isCurrentTarget
                              ? 'bg-[#161719] border-blue-500 text-white shadow-blue-500/20 shadow-lg'
                        ...
                        <div className="pt-1">
                          <div className="flex items-center gap-2 mb-0.5">
                            ...
                            {isCurrentTarget && (
                              <span className="text-[9px] px-1.5 py-0.5 rounded bg-blue-500/20 text-blue-400 font-bold uppercase tracking-wider">Mục tiêu</span>
                            )}
                          </div>
                          ...
                          <div className="text-sm mt-0.5 text-zinc-400">
                            ...
                            <span className={isCompleted || isCurrentTarget ? 'text-teal-400 font-semibold' : 'text-zinc-500'}>
                              {level.reward}
                            </span>
                          </div>
                        </div>
          ...
          <div className="flex-1 flex flex-col gap-6 lg:sticky lg:top-24 h-fit">
            ...
            <ScrollReveal animation="fade-down" className="bg-gradient-to-br from-white/[0.06] to-white/[0.02] rounded border border-white/10 p-1 relative overflow-hidden shadow-xl">
              <div className="absolute top-0 right-0 p-8 opacity-10 pointer-events-none">
                 <svg className="w-40 h-40 text-blue-500 transform rotate-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="bg-[#090A0C]/40 backdrop-blur-md rounded p-6 sm:p-8 relative z-10 border border-white/[0.05]">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded bg-blue-500/10 border border-blue-500/20 text-blue-400 text-sm font-medium shadow-sm">
                  ...
                  <div className="flex flex-col justify-center">
                    <div className="flex justify-between items-end mb-3">
                      ...
                      <div className="text-right">
                        <div className="text-2xl font-bold text-teal-400">{progressPercent.toFixed(1)}%</div>
                      </div>
                    </div>
            ...
            <ScrollReveal animation="fade-up" staggerChildren={0.1} delay={0.2} className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <ScrollRevealItem className="bg-white/[0.03] rounded border border-white/10 p-5 flex items-center gap-4 hover:border-blue-400/30 transition shadow-sm">
              ...
              <ScrollRevealItem className="bg-white/[0.03] rounded border border-white/10 p-5 flex items-center gap-4 hover:border-blue-400/30 transition shadow-sm">
                 <div className="w-12 h-12 rounded bg-indigo-500/15 border border-indigo-400/30 text-indigo-400 flex items-center justify-center shrink-0 shadow-lg shadow-indigo-500/10">
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <tr className="hover:bg-white/[0.04] transition-colors">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded bg-teal-500/15 text-teal-400 flex items-center justify-center shrink-0 shadow-lg shadow-teal-500/10 border border-teal-500/30">
                      ...
                      <td className="px-6 py-4 text-right">
                        <span className="inline-flex items-center gap-1.5 text-xs font-bold text-teal-400 bg-teal-500/10 border border-teal-500/20 px-2.5 py-1 rounded-full">
