      ...
      <main id="main-content" className="flex-grow  bg-[#090A0C]">
          ...
          <div className="relative max-w-7xl mx-auto px-4 lg:px-8 pt-8 pb-10 lg:pb-14">
            ...
            <div className="grid lg:grid-cols-12 gap-8 lg:gap-10 items-start">
              ...
              <div className="lg:col-span-7">
                ...
                <div className="relative rounded overflow-hidden border border-white/10 bg-gradient-to-br from-blue-500/10 to-zinc-900 aspect-video shadow-xl shadow-black/30 mb-6">
                  ...
                  {course.previewsCount > 0 && (
                    <div className="absolute bottom-3 left-3 inline-flex items-center gap-1.5 rounded-full bg-zinc-950/70 backdrop-blur-sm border border-white/10 px-2.5 py-1 text-[10px] font-bold text-[#00C2FF] uppercase tracking-wider">
                      ▶ Có bài học miễn phí
                    </div>
                  )}

                  <div className="absolute top-3 right-3">
                    <span className="rounded-full bg-gradient-to-r from-blue-400 to-cyan-500 text-zinc-950 px-3 py-1 text-[10px] font-extrabold uppercase tracking-wider shadow-lg">⭐ FEATURED</span>
                  </div>
                </div>

                {/* Categories & badges */}
                <div className="flex flex-wrap items-center gap-2 mb-4">
                  <span className="inline-flex items-center gap-1.5 rounded-full bg-[#00C2FF]/15 border border-[#00C2FF]/30 text-[#00C2FF] px-2.5 py-0.5 text-xs font-semibold">
                ...
                <div className="mt-5 grid grid-cols-3 gap-3">
                  <div className="rounded border border-white/10 bg-gradient-to-b from-white/[0.06] to-white/[0.02] p-4">
                    ...
                    {course.previewsCount > 0 && (
                      <div className="text-[10px] text-[#00C2FF] mt-0.5">{course.previewsCount} preview</div>
                    )}
                  </div>
                  <div className="rounded border border-white/10 bg-gradient-to-b from-white/[0.06] to-white/[0.02] p-4">
                    <div className="flex items-center gap-2 mb-1">
                    ...
                    <div className="font-extrabold text-cyan-300 text-base">{course.duration}</div>
                  </div>
                  <div className="rounded border border-white/10 bg-gradient-to-b from-white/[0.06] to-white/[0.02] p-4">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-base">🧠</span>
                    ...
                    <div className="font-extrabold text-[#00C2FF] text-base truncate">{course.difficultyLabel}</div>
                  </div>
                </div>

                {/* Author Card */}
                <div className="mt-5 flex items-center gap-3 rounded border border-white/10 bg-white/[0.03] px-4 py-3">
                  <div className="h-10 w-10 rounded-full bg-gradient-to-br from-blue-400 to-cyan-600 flex items-center justify-center text-zinc-950 font-extrabold text-sm shrink-0">
                    BR
                  </div>
              ...
              <div className="lg:col-span-5">
                <div className="sticky top-24 rounded border border-[#00C2FF]/30 bg-gradient-to-b from-[#08152B] via-[#050D1A] to-[#020712] p-5 md:p-6 shadow-2xl">
                  <div className="mb-4">
                    <div className="inline-flex items-center gap-1.5 rounded-full bg-[#00C2FF]/15 border border-[#00C2FF]/30 px-2.5 py-0.5 text-[10px] uppercase tracking-[0.12em] text-[#00C2FF] font-bold mb-2">
                      <span className="h-1.5 w-1.5 rounded-full bg-[#00C2FF] animate-pulse"></span>
                      {course.isFree ? "MIỄN PHÍ" : "PREMIUM"}
                    </div>
                    <div className="text-4xl font-extrabold text-[#00C2FF]">{course.priceAmount}</div>
                  ...
                  <div className="space-y-2">
                    <Link href={`/courses/${course.slug}`} className="block w-full rounded-xl bg-gradient-to-r from-[#00C2FF] to-[#0052FF] px-6 py-4 text-center font-extrabold text-white hover:brightness-110 transition shadow-xl shadow-[#00C2FF]/20 text-base">
                      ▶ Vào học
                    </Link>
                  </div>
                  ...
                  <ul className="mt-5 pt-5 border-t border-white/5 space-y-2.5 text-sm text-zinc-300">
                    <li className="flex items-center gap-2">
                      <svg className="h-4 w-4 text-[#00C2FF] shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" /></svg>
        ...
        <section className="border-b border-white/5">
          <div className="max-w-7xl mx-auto px-4 lg:px-8 py-12">
            <div className="mb-6">
              <div className="inline-flex items-center gap-2 rounded-full border border-[#00C2FF]/30 bg-[#00C2FF]/10 px-3 py-1 text-xs font-bold text-[#00C2FF] mb-2">🎯 KIẾN THỨC</div>
            ...
            <div className="grid md:grid-cols-2 gap-3">
              {course.benefits.map((benefit: string, idx: number) => {
                ...
                return (
                  <div key={idx} className={`flex items-start gap-3 rounded-xl border border-slate-800 bg-[#050D1A] p-4 ${isHeading ? "md:col-span-2 border-[#00C2FF]/30 bg-[#08152B]" : ""}`}>
                    {!isHeading && (
                      <span className="inline-flex items-center justify-center h-7 w-7 rounded-lg bg-[#00C2FF]/15 border border-[#00C2FF]/30 shrink-0 mt-0.5">
                        <svg className="h-4 w-4 text-[#00C2FF]" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" /></svg>
                      </span>
                    )}
                    <span className={`text-sm leading-relaxed ${isHeading ? "text-[#00C2FF] font-bold text-base" : "text-zinc-200"}`}>{cleanText}</span>
                  </div>
                );
              })}
            </div>
        ...
        <section className="border-b border-white/5">
          <div className="max-w-7xl mx-auto px-4 lg:px-8 py-12">
            <div className="mb-6 flex items-end justify-between gap-3 flex-wrap">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full border border-[#00C2FF]/30 bg-[#00C2FF]/10 px-3 py-1 text-xs font-bold text-[#00C2FF] mb-2">📚 CHƯƠNG TRÌNH</div>
              ...
              <div className="text-sm text-zinc-400">
                ...
                {course.previewsCount > 0 && (
                  <> · <strong className="text-[#00C2FF]">{course.previewsCount} preview</strong></>
                )}
              </div>
            </div>

            <div className="rounded-2xl border border-slate-800 bg-[#050D1A] overflow-hidden divide-y divide-slate-800">
              {course.lessons.map((lesson: any) => (
                <div key={lesson.id} className="flex items-center gap-4 px-4 md:px-6 py-4 transition group hover:bg-white/5">
                  <div className="font-mono text-xs font-bold text-zinc-500 tabular-nums w-8 shrink-0">{lesson.id}</div>
                  <div className="h-9 w-9 rounded-full flex items-center justify-center shrink-0 transition bg-[#00C2FF]/10 border border-[#00C2FF]/30 text-[#00C2FF] group-hover:bg-[#00C2FF]/20">
                    <svg className="h-4 w-4 ml-0.5" fill="currentColor" viewBox="0 0 20 20"><path d="M6 4l10 6-10 6V4z"></path></svg>
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="font-semibold text-white group-hover:text-[#00C2FF] transition truncate">{lesson.title}</div>
                  </div>
                  <div className="flex items-center gap-2 shrink-0 text-xs">
                    {lesson.isPreview && (
                      <span className="rounded-full bg-[#00C2FF]/15 border border-[#00C2FF]/30 text-[#00C2FF] px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider">Preview</span>
                    )}
                  </div>
                </div>
              ))}
        ...
        <section>
          <div className="max-w-4xl mx-auto px-4 lg:px-8 py-12">
            <div className="rounded border border-blue-400/30 bg-gradient-to-br from-blue-500/15 via-cyan-500/5 to-transparent p-8 md:p-12 text-center relative overflow-hidden">
              ...
              <div className="relative">
                <h3 className="text-2xl md:text-3xl font-extrabold text-white mb-3">
                  Sẵn sàng bắt đầu{" "}
                  <span className="bg-gradient-to-r from-blue-300 to-cyan-500 bg-clip-text text-transparent">{course.title}</span>?
                </h3>
                <p className="text-zinc-400 mb-6 max-w-xl mx-auto">Truy cập trọn đời, học mọi lúc, có chứng chỉ hoàn thành.</p>
                <Link href={`/courses/${course.slug}`} className="inline-flex items-center gap-2 rounded bg-gradient-to-r from-blue-400 to-cyan-600 px-8 py-4 font-extrabold text-zinc-950 hover:from-blue-300 hover:to-cyan-500 transition shadow-xl shadow-blue-500/30 text-base">
