...
const ibBrokers = [
  {
    ...
    rating: "4.5",
    trustBadge: "Mới",
    trustClass: "bg-teal-500/20 text-teal-300 border border-teal-500/30",
    type: "Rebate",
    mechanisms: [
          ...
          <div className="relative max-w-7xl mx-auto px-4 lg:px-8 py-12 lg:py-16 text-center">
            ...
            <div className="mt-10 grid grid-cols-3 gap-4 max-w-2xl mx-auto">
              <div className="rounded border border-white/10 bg-white/[0.03] p-5">
                <div className="text-3xl md:text-4xl font-extrabold text-blue-300">15</div>
                <div className="text-xs text-zinc-500 mt-1">Brokers</div>
              </div>
              <div className="rounded border border-white/10 bg-white/[0.03] p-5">
                <div className="text-3xl md:text-4xl font-extrabold text-teal-300">46</div>
                <div className="text-xs text-zinc-500 mt-1">Mechanisms</div>
              </div>
              <div className="rounded border border-white/10 bg-white/[0.03] p-5">
                <div className="text-3xl md:text-4xl font-extrabold text-cyan-300">4</div>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8 py-10">
          ...
          <details className="rounded border border-white/10 bg-white/[0.03] mb-8 group">
            ...
            <div className="px-5 pb-5 pt-2 text-sm text-zinc-400 leading-relaxed border-t border-white/5 mt-2">
              ...
              <div className="mt-6 pt-4 border-t border-white/5">
                ...
                <p className="text-blue-400 font-semibold">Đội ngũ HieuNTHUB</p>
              </div>
            </div>
          </details>
          ...
          <section className="mb-8">
            <div className="flex flex-col lg:flex-row lg:items-center gap-4">
              ...
              {/* Search Bar */}
              <div className="flex items-center gap-3 rounded border border-white/10 bg-white/5 px-4 py-2.5 lg:w-80 focus-within:border-blue-400/50 transition">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {ibBrokers.map((broker, idx) => (
              <article key={idx} className="rounded border border-white/10 bg-gradient-to-b from-white/[0.05] to-white/[0.01] hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/10 transition p-6 flex flex-col justify-between">
                ...
                <div>
                  <div className="flex items-start justify-between gap-4 mb-4">
                    ...
                    <div className="flex flex-col items-end gap-1.5">
                      ...
                      <span className="px-2 py-0.5 rounded bg-blue-500/20 text-blue-300 border border-blue-500/30 text-[9px] font-extrabold uppercase tracking-wider">
                        {broker.type}
                      </span>
                    </div>
                  </div>
                        ...
                        <Link href={`/mechanisms/${broker.slug}/${currentCommType}/${mech.name.toLowerCase().replace(/ /g, "-")}`} className="flex items-center justify-between p-3 text-xs">
                          ...
                          <div className="flex items-center gap-2">
                            <span className="text-zinc-200">
                              <strong className="text-blue-400">{mech.gold}</strong> Gold
                            </span>
                            <span className="text-zinc-500">•</span>
                            <span className="text-zinc-200">
                              <strong className="text-teal-400">{mech.fx}</strong> FX
                            </span>
                ...
                {/* foot review button */}
                <div className="mt-6 pt-4 border-t border-white/5">
                  <Link href={`/brokers/danh-gia-${broker.slug}`} className="flex items-center justify-center gap-1.5 text-xs text-zinc-400 hover:text-blue-300 transition font-bold">
