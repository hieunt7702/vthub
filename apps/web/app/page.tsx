    ...
    <>
      ...
      <main id="main-content" className="flex-grow">
        ...
        <section className="relative overflow-hidden border-b border-white/5 bg-zinc-950 pb-20 pt-28 lg:pt-36">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1200px] h-[600px] bg-gradient-to-tr from-teal-500/20 to-teal-600/20 rounded blur-[150px] pointer-events-none mix-blend-screen"></div>
          <div className="absolute top-1/4 right-1/4 w-80 h-80 bg-teal-500/10 rounded-full blur-[100px] pointer-events-none"></div>
          ...
          <div className="absolute top-0 left-[20%] w-96 h-96 bg-teal-500/20 rounded-full blur-[120px] pointer-events-none mix-blend-screen animate-pulse duration-1000"></div>
          <div className="absolute bottom-[-10%] right-[10%] w-[500px] h-[500px] bg-teal-600/15 rounded-full blur-[150px] pointer-events-none mix-blend-screen animate-pulse" style={{ animationDelay: '2s' }}></div>
          <div className="absolute top-[30%] left-[40%] w-64 h-64 bg-teal-500/10 rounded-full blur-[100px] pointer-events-none mix-blend-screen animate-pulse" style={{ animationDelay: '1s' }}></div>
          ...
          <div className="absolute inset-0 pointer-events-none hidden xl:block z-0">
            ...
            <div className="absolute top-[12%] right-1/2 mr-[450px] 2xl:mr-[550px] animate-float origin-right scale-90 2xl:scale-100 pointer-events-auto group">
              <div className="flex flex-col gap-3 w-72 rounded border border-teal-500/20 bg-gradient-to-br from-[#071b20]/90 via-[#041014]/95 to-zinc-950/95 backdrop-blur-xl p-5 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.6)] transition-all duration-500 group-hover:-translate-y-2 group-hover:scale-[1.02] group-hover:border-teal-500/40 group-hover:shadow-[0_0_50px_rgba(13,89,98,0.25)] overflow-hidden relative">
                <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-teal-400/40 to-transparent"></div>
                <div className="flex justify-between items-start relative z-10">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded bg-teal-500/10 border border-teal-500/20 flex items-center justify-center text-xl shadow-inner text-teal-400">🏆</div>
                    <div className="text-left">
                      <h3 className="text-white font-bold text-base leading-tight group-hover:text-teal-300 transition-colors">VT Rewards</h3>
                      <p className="text-zinc-400 text-xs mt-0.5">Hệ thống thưởng</p>
                    </div>
                  </div>
                  <div className="text-teal-400 text-xs font-bold flex items-center gap-1 mt-1 bg-teal-500/10 px-2 py-0.5 rounded border border-teal-500/20">
                    ⭐ 5.0
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-2 mt-2 relative z-10">
                  <div className="rounded bg-white/5 p-2 flex flex-col justify-center border border-transparent group-hover:border-teal-500/10 transition-colors">
                  ...
                  <div className="rounded bg-teal-500/10 p-2 flex flex-col justify-center border border-teal-500/20 shadow-[0_0_15px_rgba(13,89,98,0.05)] group-hover:shadow-[0_0_20px_rgba(13,89,98,0.15)] transition-shadow">
                    <span className="text-teal-500 text-[10px] font-bold mb-0.5 uppercase tracking-wider">Đổi quà</span>
            ...
            <div className="absolute top-[60%] right-1/2 mr-[420px] 2xl:mr-[520px] animate-float-delayed origin-right scale-90 2xl:scale-100 pointer-events-auto group">
              <div className="flex flex-col gap-3 w-72 rounded border border-teal-500/25 bg-gradient-to-br from-[#071b20]/95 via-[#041014]/98 to-zinc-950/98 backdrop-blur-xl p-5 shadow-[0_10px_40px_-10px_rgba(13,89,98,0.15)] transition-all duration-500 group-hover:-translate-y-2 group-hover:scale-[1.02] group-hover:border-teal-500/50 group-hover:shadow-[0_0_50px_rgba(13,89,98,0.3)] overflow-hidden relative">
                <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-teal-500/50 to-transparent"></div>
                <div className="flex justify-between items-start relative z-10">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded bg-teal-500/10 border border-teal-500/20 flex items-center justify-center text-xl shadow-inner text-teal-400">🤝</div>
                    <div className="text-left">
                      <h3 className="text-white font-bold text-base leading-tight group-hover:text-teal-400 transition-colors">Đối tác IB</h3>
                      <p className="text-zinc-400 text-xs mt-0.5">Cơ chế hoa hồng</p>
                    </div>
                  </div>
                  <div className="bg-gradient-to-r from-teal-500 to-teal-400 text-white px-2 py-0.5 rounded text-[10px] font-extrabold mt-1 shadow-lg animate-pulse-glow">
                    TOP PICK
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-2 mt-2 relative z-10">
                  ...
                  <div className="rounded bg-teal-500/10 p-2 flex flex-col justify-center border border-teal-500/20 shadow-[0_0_15px_rgba(13,89,98,0.05)] group-hover:shadow-[0_0_20px_rgba(13,89,98,0.15)] transition-shadow">
                    <span className="text-teal-500 text-[10px] font-bold mb-0.5 uppercase tracking-wider">Rebate</span>
                    <span className="text-white text-xs font-bold">✔</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3 w-72 rounded border border-teal-500/20 bg-gradient-to-br from-[#071b20]/90 via-[#041014]/95 to-zinc-950/95 backdrop-blur-xl p-5 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.6)] transition-all duration-500 group-hover:-translate-y-2 group-hover:scale-[1.02] group-hover:border-teal-500/40 group-hover:shadow-[0_0_50px_rgba(13,89,98,0.25)] overflow-hidden relative">
                ...
                <div className="flex justify-between items-start relative z-10">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded bg-teal-500/10 border border-teal-500/20 flex items-center justify-center text-xl shadow-inner text-teal-400">🎉</div>
                    <div className="text-left">
                      <h3 className="text-white font-bold text-base leading-tight group-hover:text-teal-300 transition-colors">Khuyến mãi</h3>
                ...
                <div className="grid grid-cols-2 gap-2 mt-2 relative z-10">
                  ...
                  <div className="rounded bg-teal-500/10 p-2 flex flex-col justify-center border border-teal-500/20 shadow-[0_0_15px_rgba(13,89,98,0.05)] group-hover:shadow-[0_0_20px_rgba(13,89,98,0.15)] transition-shadow">
                    <span className="text-teal-500 text-[10px] font-bold mb-0.5 uppercase tracking-wider">Tham gia</span>
                    <span className="text-white text-xs font-bold">✔</span>
                  </div>
                </div>
              </div>
...
\n          <ScrollReveal animation="fade-up" duration={0.8} className="relative z-10 max-w-[1400px] mx-auto px-4 lg:px-8 text-center flex flex-col items-center">
            ...
            <div className="inline-flex items-center gap-2.5 rounded-full border border-teal-500/30 bg-gradient-to-r from-teal-500/10 to-teal-500/10 backdrop-blur-md px-5 py-2 text-sm md:text-base font-semibold text-teal-300 mb-10 shadow-[0_0_30px_rgba(249,115,22,0.15)] ring-1 ring-teal-500/20 group hover:border-teal-500/50 transition-colors duration-300">
              ...
              <svg className="w-4 h-4 text-teal-400 animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
            ...
            <div className="mt-16 pt-10 border-t border-white/5 flex flex-wrap justify-center gap-6 w-full max-w-4xl">
              <div className="flex items-center gap-3 rounded border border-white/5 bg-white/[0.02] backdrop-blur-md px-6 py-3 text-sm md:text-base font-semibold text-zinc-300 hover:border-teal-500/20 hover:bg-teal-500/[0.02] hover:text-white transition-all duration-300 group shadow-lg">
                <span className="flex h-8 w-8 items-center justify-center rounded-full bg-teal-500/10 text-teal-400 group-hover:bg-teal-500/20 transition-colors">
          ...
          <div className="max-w-7xl mx-auto px-4 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <ScrollReveal animation="fade-left" delay={0.2} className="relative">
                <div className="absolute inset-0 bg-gradient-to-tr from-teal-500/20 to-teal-500/20 blur-3xl rounded-full"></div>
                <div className="relative rounded border border-white/10 bg-zinc-900/50 backdrop-blur-xl p-8 shadow-2xl overflow-hidden">
                  ...
                  <div className="space-y-4">
                    <div className="rounded bg-white/5 border border-white/5 p-4 hover:border-teal-500/30 transition">
                      <div className="font-bold text-teal-300">Quyền lợi khách hàng</div>
                      <div className="text-sm text-zinc-400 mt-1">Tổng hợp ưu đãi, hỗ trợ tài khoản dành cho trader VT Markets.</div>
                    </div>
                    <div className="rounded bg-white/5 border border-white/5 p-4 hover:border-teal-500/30 transition">
                      <div className="font-bold text-teal-300">Hệ thống thưởng giao dịch</div>
                      <div className="text-sm text-zinc-400 mt-1">Theo dõi khối lượng giao dịch, tiến độ tích lũy lot và các mốc phần thưởng.</div>
                    </div>
                    <div className="rounded bg-white/5 border border-white/5 p-4 hover:border-teal-500/30 transition">
                      <div className="font-bold text-teal-300">Cơ chế IB/Đối tác</div>
                      <div className="text-sm text-zinc-400 mt-1">Cung cấp thông tin hoa hồng, rebate và chính sách hợp tác phát triển.</div>
                    </div>
                    <div className="rounded bg-white/5 border border-white/5 p-4 hover:border-teal-500/30 transition">
                      <div className="font-bold text-teal-300">Công cụ và hỗ trợ giao dịch</div>
        ...
        <section className="py-20 lg:py-28 border-t border-white/5 relative overflow-hidden bg-zinc-950">
          ...
          <div className="max-w-7xl mx-auto px-4 lg:px-8 relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <ScrollReveal animation="fade-right">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Khách hàng VT Markets <span className="text-teal-400">nhận được gì?</span></h2>
                <ul className="space-y-4 mb-8">
                  <li className="flex items-start gap-3">
                    <svg className="w-6 h-6 text-teal-400 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                ...
                <Link href="/rewards" className="inline-flex items-center justify-center gap-2 rounded bg-teal-500/20 border border-teal-500/30 px-6 py-3 font-bold text-teal-300 hover:bg-teal-500/30 transition shadow-lg">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <ScrollReveal animation="fade-right" delay={0.2} className="order-2 lg:order-1 relative">
                <div className="rounded border border-white/10 bg-gradient-to-tr from-zinc-950 to-zinc-900 p-8 shadow-2xl relative overflow-hidden">
                  <div className="absolute bottom-0 left-0 w-32 h-32 bg-teal-500/10 blur-[50px]"></div>
                  <div className="text-5xl mb-6">🤝</div>
              ...
              <ScrollReveal animation="fade-left" className="order-1 lg:order-2">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">IB và đối tác có thêm công cụ <span className="text-teal-400">phát triển hiệu quả</span></h2>
                <ul className="space-y-4 mb-8">
                  <li className="flex items-start gap-3">
                    <svg className="w-6 h-6 text-teal-400 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                ...
                <Link href="/ib-commission-overview" className="inline-flex items-center justify-center gap-2 rounded bg-teal-500/20 border border-teal-500/30 px-6 py-3 font-bold text-teal-300 hover:bg-teal-500/30 transition shadow-lg">
                  Xem cơ chế đối tác
                </Link>
              </ScrollReveal>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 lg:px-8">
            <ScrollReveal animation="fade-up" className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-white">
                Cách VT Rewards Hub <span className="bg-gradient-to-r from-teal-400 to-teal-500 bg-clip-text text-transparent">hoạt động</span>
              </h2>
            </ScrollReveal>
            ...
            <ScrollReveal animation="fade-up" staggerChildren={0.2} className="grid md:grid-cols-4 gap-8">
              <ScrollRevealItem className="relative">
                <div className="h-16 w-16 rounded-full bg-teal-500/20 border-2 border-teal-400 text-teal-400 text-2xl font-bold flex items-center justify-center mb-6 shadow-[0_0_15px_rgba(251,146,60,0.3)]">1</div>
                <div className="hidden md:block absolute top-8 left-16 right-0 h-[2px] bg-gradient-to-r from-teal-500/50 to-transparent"></div>
              ...
              <ScrollRevealItem className="relative">
                <div className="h-16 w-16 rounded-full bg-teal-500/20 border-2 border-teal-400 text-teal-400 text-2xl font-bold flex items-center justify-center mb-6">2</div>
                <div className="hidden md:block absolute top-8 left-16 right-0 h-[2px] bg-gradient-to-r from-teal-500/50 to-transparent"></div>
              ...
              <ScrollRevealItem className="relative">
                <div className="h-16 w-16 rounded-full bg-teal-500/20 border-2 border-teal-400 text-teal-400 text-2xl font-bold flex items-center justify-center mb-6">3</div>
                <div className="hidden md:block absolute top-8 left-16 right-0 h-[2px] bg-gradient-to-r from-teal-500/50 to-transparent"></div>
              ...
              <ScrollRevealItem className="relative">
                <div className="h-16 w-16 rounded-full bg-teal-500/20 border-2 border-teal-400 text-teal-400 text-2xl font-bold flex items-center justify-center mb-6">4</div>
          ...
          <div className="max-w-7xl mx-auto px-4 lg:px-8 relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <ScrollReveal animation="fade-right" staggerChildren={0.1} className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
                <ScrollRevealItem className="rounded border border-white/10 bg-gradient-to-br from-white/[0.08] to-white/[0.02] p-6 hover:border-teal-400/40 hover:shadow-xl transition flex flex-col justify-between">
              ...
              <ScrollReveal animation="fade-left" delay={0.2}>
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Sự khác biệt của <span className="text-teal-400">VT Rewards Hub</span></h2>
        ...
        <section className="border-t border-white/5">
          <ScrollReveal animation="scale-up" className="max-w-7xl mx-auto px-4 lg:px-8 py-20 lg:py-32 text-center">
            ...
            <Link href="/rewards" className="inline-block rounded bg-gradient-to-r from-teal-400 to-teal-600 px-10 py-5 font-bold text-zinc-950 hover:from-teal-300 hover:to-teal-500 transition shadow-xl shadow-teal-500/30 text-xl">
