      ...
      <>
        ...
        <main id="main-content" className="flex-grow bg-[#090A0C] min-h-screen text-zinc-300 relative overflow-hidden flex flex-col">
          ...
          <div className="flex-1 flex items-center justify-center p-4 relative z-10 min-h-[calc(100vh-160px)]">
            <div className="max-w-md w-full bg-gradient-to-b from-white/[0.06] to-white/[0.02] backdrop-blur-xl border border-white/10 rounded p-8 shadow-2xl shadow-indigo-500/10 text-center">
              <div className="w-20 h-20 bg-gradient-to-br from-indigo-400 to-fuchsia-600 rounded mx-auto mb-6 flex items-center justify-center shadow-lg shadow-indigo-500/30">
              ...
              <button
                ...
                disabled={isLinking}
                className="w-full relative group overflow-hidden rounded border border-white/10 p-1 transition-all hover:border-indigo-500/50 bg-[#161719]"
              >
                ...
                <div className="relative bg-gradient-to-r from-indigo-400 to-fuchsia-600 text-zinc-950 font-bold py-3.5 px-6 rounded flex items-center justify-center gap-2 transition-transform active:scale-[0.98]">
                  {isLinking ? (
                    <>
        ...
        <div className="max-w-[1200px] mx-auto px-4 lg:px-8 py-8 relative z-10 pt-10">
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
              ...
              {/* XAUUSD Banner */}
              <div className="md:col-span-6 bg-gradient-to-r from-cyan-900/40 to-cyan-600/20 rounded border border-cyan-500/30 p-6 relative overflow-hidden flex items-center shadow-lg shadow-cyan-500/10">
                ...
                <div className="relative z-10 w-full">
                  ...
                  <div className="text-4xl font-extrabold bg-gradient-to-r from-cyan-200 via-cyan-400 to-cyan-500 bg-clip-text text-transparent drop-shadow-sm">4,508.37</div>
                </div>
              </div>
              ...
              {/* Fee Per Try */}
              <div className="md:col-span-3 bg-black/40 rounded border border-white/10 p-5 flex flex-col items-center justify-center text-center mt-0 shadow-lg">
                <div className="w-10 h-10 rounded bg-cyan-500/20 text-cyan-400 flex items-center justify-center mb-3">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="md:col-span-6 bg-[#161719] rounded border border-indigo-500/30 p-6 flex flex-col justify-center shadow-lg">
                ...
                <div className="flex gap-3">
                  <input 
                    type="text" 
                    placeholder="VD: 0123" 
                    className="flex-1 bg-black/40 border border-white/10 rounded px-4 py-2.5 text-white placeholder-zinc-600 focus:outline-none focus:border-indigo-500/50 transition-colors"
                  />
                  <button className="bg-gradient-to-r from-indigo-500 to-fuchsia-600 hover:from-indigo-400 hover:to-fuchsia-500 text-white font-semibold px-5 py-2.5 rounded transition flex items-center gap-2 shadow-lg shadow-indigo-500/20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              <div className="lg:col-span-2 bg-black/40 rounded border border-white/10 overflow-hidden flex flex-col shadow-lg">
                <div className="p-5 border-b border-white/10 flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-base font-bold text-white">Bảng giải thưởng hôm nay <span className="text-cyan-400">01/06/2026</span></h3>
                  </div>
                </div>
                ...
                <div className="flex-1 p-5 pt-2 overflow-x-auto">
                  <table className="w-full text-left border-collapse min-w-[500px]">
                    <thead>
                      <tr className="text-[10px] text-cyan-500 uppercase tracking-wider font-bold border-b border-white/10">
                    ...
                    <tbody className="divide-y divide-white/5 text-xs">
                      <tr className="hover:bg-white/[0.02]">
                        <td className="py-3 px-2">
                          <span className="inline-block px-2.5 py-0.5 rounded-full bg-cyan-500/20 border border-cyan-500/30 text-cyan-400 font-semibold text-[10px]">Nhất</span>
                        </td>
                        <td className="py-3 px-2 text-center text-white font-medium">1</td>
                        <td className="py-3 px-2 text-zinc-500">Chưa có</td>
                        <td className="py-3 px-2 text-right text-cyan-400 font-bold">$0.20</td>
                      ...
                      <tr className="hover:bg-white/[0.02]">
                        <td className="py-3 px-2">
                          <span className="inline-block px-2.5 py-0.5 rounded-full bg-blue-500/20 border border-blue-500/30 text-blue-400 font-semibold text-[10px]">Ba</span>
                        </td>
                        <td className="py-3 px-2 text-center text-white font-medium">1</td>
                        <td className="py-3 px-2 text-zinc-500">Chưa có</td>
                        <td className="py-3 px-2 text-right text-cyan-400 font-bold">$0.12</td>
                        <td className="py-3 px-2 text-right text-white font-medium">$0.12</td>
                        <td className="py-3 px-2 text-right text-zinc-500">$6.00</td>
                      </tr>
                      <tr className="hover:bg-white/[0.02]">
                        <td className="py-3 px-2">
                          <span className="inline-block px-2.5 py-0.5 rounded-full bg-indigo-500/20 border border-indigo-500/30 text-indigo-400 font-semibold text-[10px]">Tư</span>
                        </td>
                        <td className="py-3 px-2 text-center text-white font-medium">2</td>
                        <td className="py-3 px-2 text-zinc-500">Chưa có</td>
                        <td className="py-3 px-2 text-right text-cyan-400 font-bold">$0.16</td>
                        <td className="py-3 px-2 text-right text-white font-medium">$0.08</td>
                        <td className="py-3 px-2 text-right text-zinc-500">$8.00</td>
                      </tr>
                      <tr className="hover:bg-white/[0.02]">
                        <td className="py-3 px-2">
                          <span className="inline-block px-2.5 py-0.5 rounded-full bg-indigo-400/10 border border-indigo-400/20 text-indigo-300 font-semibold text-[10px]">Khuyến khích</span>
                        </td>
                ...
                <div className="p-3 border-t border-white/10 flex items-center justify-between bg-white/[0.01]">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex gap-1 ml-2">
                      ...
                      <button className="w-6 h-6 rounded bg-cyan-500 text-black font-bold flex items-center justify-center text-xs">
                        1
                      </button>
                      <button className="w-6 h-6 rounded bg-white/5 text-zinc-600 flex items-center justify-center cursor-not-allowed">
