        ...
        <section className="relative overflow-hidden border-b border-white/5">
          ...
          <div className="relative max-w-7xl mx-auto px-4 lg:px-8 py-8 lg:py-12">
            ...
            <nav className="text-xs text-zinc-500 mb-5">
              ...
              <Link href="/brokers" className="hover:text-blue-300">Sàn giao dịch</Link>
              <span className="mx-2">›</span>
            ...
            <div className="text-center max-w-3xl mx-auto">
              ...
              <h1 className="text-3xl md:text-5xl font-extrabold text-white tracking-tight">
                Chọn sàn để{" "}
                <span className="bg-gradient-to-r from-blue-300 via-cyan-400 to-cyan-500 bg-clip-text text-transparent">so sánh</span>
              </h1>
        ...
        <section>
          <div className="max-w-2xl mx-auto px-4 lg:px-8 py-16 text-center">
            <div className="rounded border border-white/10 bg-gradient-to-b from-white/[0.06] to-white/[0.02] p-8 md:p-12">
              ...
              <Link href="/brokers" className="inline-flex items-center gap-2 rounded bg-gradient-to-r from-blue-400 to-cyan-600 px-8 py-4 font-bold text-zinc-950 hover:from-blue-300 hover:to-cyan-500 transition shadow-xl shadow-blue-500/30">
                Tìm sàn để so sánh →
              </Link>
            </div>
          </div>
